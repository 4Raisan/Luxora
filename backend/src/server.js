...
app.put('/api/profile/steam', authMiddleware, async (req, res, next) => {
  try {
...
app.post('/api/wishlist/sync', authMiddleware, async (req, res, next) => {
  try {
...
app.get('/api/categories', authMiddleware, async (req, res, next) => {
  try {
...
app.post('/api/categories', authMiddleware, async (req, res, next) => {
  try {
    const { name } = req.body;
    if (!name?.trim()) {
...
app.put('/api/categories/:id', authMiddleware, async (req, res, next) => {
  try {
...
app.delete('/api/categories/:id', authMiddleware, async (req, res, next) => {
  try {
    const categoryId = Number(req.params.id);
...
app.post('/api/categories/reorder', authMiddleware, async (req, res, next) => {
  try {
